...
<div class="main-content">
    {{-- BREADCRUMB --}}
    <x-breadcrumb :heading="__('Pelanggan')" :sub-heading="__('Daftar Pelanggan')"></x-breadcrumb>
    {{-- END BREADCRUMB --}}
        ...
        <div class="card-body">
            <div class="table-responsive white-space-nowrap">
                <table class="table align-middle">
                    ...
                    <tbody>
                    @forelse($this->customers as $key => $value)
                        <tr>
                            <td>{{ ($this->customers->currentPage() - 1) * $this->customers->perPage() + $key + 1}}</td>
                            <td>{{ $value->name }}</td>
                            <td>{{ $value->email }}</td>
    ...
    {{-- Modal Form --}}
    <livewire:pages::admin-panels.customers.form/>
    @endisland
</div>
